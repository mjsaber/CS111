...
# interrupting a blocked lock doesn't destroy the wait order
 ...
 # #18
 #    [ '(./osprdaccess -r -l /dev/osprda  && (echo a | ./osprdaccess -w 1 -l /dev/osprdb)) &  '.
 #    '(./osprdaccess -r -l /dev/osprdb  && (echo a | ./osprdaccess -w 1 -l /dev/osprdc)) & '.
 #    './osprdaccess -r -l /dev/osprdc  && (echo a | ./osprdaccess -w 1 -l /dev/osprda) ',
 #      "a"
 #    ],
